...
//            writeAnkiClassName(activity.getPackageName(),activity,fileName);
//        }
//        fileName = Environment.getExternalStorageDirectory().getAbsolutePath()+"/netease.txt";
//        if(activity.getPackageName().contains("com.netease.cloudmusic")){
//            writeAnkiClassName(activity.getPackageName(),activity,fileName);
//        }
//        fileName = Environment.getExternalStorageDirectory().getAbsolutePath()+"/dangdang.txt";
//        if(activity.getPackageName().contains("com.dangdang.buy2")){
//            writeAnkiClassName(activity.getPackageName(),activity,fileName);
//        }
